                                        ...
                                        <div class="card-block">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    ...
                                                    <h6 class="text-muted f-w-400">NAME@gmail.com</h6>
                                                </div>
                                                <div class="col-sm-10">
                                                    <p class="m-b-10 f-w-600">Phone</p>
                                                    <h6 class="text-muted f-w-400">98XXXXXXXX</h6>
                                                </div>
                                            </div>
                                            <h6 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600"></h6>
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <p class="m-b-10 f-w-600">Organisation</p>
                                                    <h6 class="text-muted f-w-400">XXXX</h6>
                                                </div>
                                                <div class="col-sm-6">
                                                    <p class="m-b-10 f-w-600">GST</p>
                                                    <h6 class="text-muted f-w-400">XXX</h6>
                                                </div>
                                                <div class="row-sm-10">
                                                    <button><a href=""></a>Log Out</button>
                                                </div>
                                            </div>
